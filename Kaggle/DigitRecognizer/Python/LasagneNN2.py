...
#    exit(0)
    ...
    cvSplit = StratifiedShuffleSplit(y, 1, test_size=0.2)       # Only one iteration
...
def RunNN(X_train, y_train, X_val, y_val, X_test, y_test, model='mlp', num_epochs=10):
